...
hi Todo       guifg=white guibg=NONE  cterm=NONE  gui=underline

" Code-specific colors
hi pythonOperator guifg=#7e8aa2 gui=none ctermfg=103

" Diff colors
hi DiffAdd ctermbg=green ctermfg=234
hi DiffChange ctermbg=111 ctermfg=234
hi DiffText ctermbg=gray ctermfg=234
...
" background color and sidebar tweaks
hi VertSplit guibg=bg ctermfg=bg ctermbg=fg
hi NonText ctermbg=bg ctermfg=bg guibg=bg guifg=bg

" signs
hi SignColumn guifg=#d3d3d5 guibg=bg gui=none ctermfg=253 ctermbg=bg cterm=none
